        ...
        <div className="auto-listings-details d-flex">
          ...
          <div className="auto-range-sort">
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item onClick={() => handleMakeSelection("All Makes")}>
                  All Makes
                </Dropdown.Item>
                <Dropdown.Item
                ...
                <Dropdown.Item onClick={() => handleMakeSelection("Nissan")}>
                  Nissan
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleMakeSelection("Renault")}>
                  Renault
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleMakeSelection("Mazda")}>
                  Mazda
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleMakeSelection("Audi")}>
                  Audi
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleMakeSelection("DS 7")}>
                  DS 7
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item
                  onClick={() => handleFuelTypeSelection("All Fuel Types")}
                >
                  All FuelType
                </Dropdown.Item>
                <Dropdown.Item
                ...
                <Dropdown.Item
                  onClick={() => handleFuelTypeSelection("plugin electric")}
                >
                  Plugin Electric
                </Dropdown.Item>
              </Dropdown.Menu>
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item
                  onClick={() => handleTransmissionSelection("Semi-Automatic")}
                >
                  Semi-Automatic
                </Dropdown.Item>
              </Dropdown.Menu>
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item
                  onClick={() => handleConditionSelection("All Conditions")}
                >
                  All Condition
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleConditionSelection("Used")}>
                  Used
                </Dropdown.Item>
                <Dropdown.Item onClick={() => handleConditionSelection("New")}>
                  New
                </Dropdown.Item>
                <Dropdown.Item
